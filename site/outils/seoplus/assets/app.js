...
(function () {
  ...
  function basculerLangue(vers) {
    ...
    $$('a[href]').forEach(function (a) {
      ...
      /* Les liens du HTML portent le prefixe du site depuis la migration en
         ...
         le prefixe est remis avant l'ecriture : sans ca, « /outils/seoplus/ »
  ...
  function buildFiles(data) {
    ...
    if (!sg.robots) files.push({
      ...
      code: "# robots.txt - genere par SEOPlus! (www.optimizia.xyz/outils/seoplus)\nUser-agent: *\nAllow: /\n\nSitemap: " + origin + "/sitemap.xml"
    });
  ...
  function trustBadgeHtml() {
    ...
    return '<a href="https://www.optimizia.xyz/outils/seoplus/?utm_source=badge&amp;utm_medium=referral" target="_blank" rel="noopener" ' +
  ...
  function initLlms() {
    ...
    function build() {
      ...
      lines.push("");
      lines.push(isEN
        ? "<!-- Generated with SEOPlus! - free llms.txt generator: https://www.optimizia.xyz/outils/seoplus/ -->"
        : "<!-- Généré avec SEOPlus! - générateur llms.txt gratuit : https://www.optimizia.xyz/outils/seoplus/ -->");
